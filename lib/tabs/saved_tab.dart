...
class SavedPageTab extends StatefulWidget {

  @override
  _SavedPageTabState createState() => _SavedPageTabState();
}

class _SavedPageTabState extends State<SavedPageTab> {
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.connectionState == ConnectionState.done) {
                  ...
                  return ListView(
                    ...
                    children: snapshot.data.docs.map((document) { // loops through all the documents and returns column widget
                      return Column(
                        children: [
                          GestureDetector(
                              onTap: () {
                              ...
                              child: FutureBuilder(
                                  future: _firebaseServices.productsRef.doc(document.id).get(), // data of specific product
